...
export default function Home() {
  ...
  return (
    <div className="flex flex-col pt-20 ">
      <section className="mt-20 pb-12 space-y-10 md:space-y-20 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <h1 className="gradient-title mx-auto max-w-4xl text-4xl font-bold md:text-7xl">
            The smartest way to split your expenses.
          </h1>
      ...
      <section id="features" className="bg-gray-50 dark:bg-[#0a0a0a] py-20">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <h1 className="gradient-title mt-2 text-3xl md:text-4xl">
      ...
      <footer className="border-t bg-gray-50 dark:bg-black py-12 text-center text-sm text-muted-foreground">
        Made with ❤️ by <a href="https://github.com/PriyanshV10">Priyansh</a>
      </footer>
    </div>
  );
}
